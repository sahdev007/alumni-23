...
export class JobTypesComponent implements OnInit {
  ...
  add(data: any, action: string){
    this.router.navigate(['/careers-jobs/add-edit-job-type'], {queryParams: {id: data?.id, action: action}});
  }

  edit(data: any, params: any) {
    this.router.navigate(['/careers-jobs/add-edit-job-type'], {queryParams: {id: data?.id, action: params}});
  }

  view(data: any){ 
    this.router.navigate(['/careers-jobs/view-job-type'], {queryParams: {id: data?.id}});
  }
